                            ...
                            <div class="menu-header-content bg-primary text-right">
                                <div class="d-flex">
                                    ...
                                    <span class="badge badge-pill badge-warning mr-auto my-auto float-left">
                                        <a href="{{ route('markasread') }}">Read All</a>
                                    </span>
                                </div>
                                ...
                                <div id="unreadNotifications">
                                    @foreach (auth()->user()->unreadNotifications as $notification)
                                        <a class="d-flex p-3 border-bottom align-items-center"
                                            href="{{ url('invoice-details') }}/{{ $notification->data['id'] }}">
                                            ...
                                            <div class="mr-3">
                                                ...
                                                <div class="notification-subtext">
                                                    {{ $notification->created_at->toDateString() }}</div>
                                            </div>
                                            <div class="mr-auto">
                    ...
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                ...
                                <div class="mr-3 my-auto" style="overflow:hidden">

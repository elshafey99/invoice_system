...
@section('title', 'Invoicing Reports')
@endsection
@section('page-header')
    <!-- breadcrumb -->
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <form action="/Search_invoices" method="POST" role="search" autocomplete="off">
                        ...
                        <div class="col-lg-3">
                            <label class="rdiobox">
                                <input checked name="rdio" type="radio" value="1" id="type_div"> <span>Search by invoice
                                    type</span></label>
                        </div>
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            <label class="rdiobox"><input name="rdio" value="2" type="radio"><span>Search by invoice
                                    number</span></label>
                        </div><br><br>
                        <div class="row">
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                                <p class="mg-b-10">Select type of invoices</p><select class="form-control select2"
                                    name="type" required>
                                    ...
                                    <option value="partly_paid">Partially paid invoices</option>
                                </select>
                            </div><!-- col-4 -->
                            ...
                            <div class="col-lg-3" id="start_at">
                                <label for="exampleFormControlSelect1">From a date</label>

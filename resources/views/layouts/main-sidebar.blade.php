        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'dashboard')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">Home</span>
                </a>
            </li>
            @can('Invoices')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @endcan
                        @can('Paid Invoices')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices/invoice-paid')) }}">Paid
                                    Invoices</a></li>
                        @endcan
                        @can('Unpaid Invoices')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices/invoice-unpaid')) }}">Unpaid
                                    Invoices</a></li>
                        @endcan
                        @can('Partially Paid Invoices')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices/invoice-partial')) }}">Partially
                                    Paid Invoices</a></li>
                        @endcan
                        @can('Invoice Archive')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices/view-archive')) }}">Archived
                                    Invoices</a></li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('Reports')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('Invoice Report')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'cards')) }}">Invoicing Reports</a></li>
                        @endcan
                        @can('Customer Report')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'darggablecards')) }}">Customer Reports</a>
                            </li>
                        @endcan
                    </ul>
                </li>
            ...
            @can('Users')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('User List')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'users/view')) }}">User List</a></li>
                        @endcan
                        @can('User Permissions')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'roles/view')) }}">User Permissions</a>
                            </li>
                        @endcan
                    </ul>
                </li>
